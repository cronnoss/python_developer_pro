...
Implemented in: [hw_14/memc_load_multi.py](hw_14/memc_load_multi.py)

Run commands
```bash
python3 memc_load.py --pattern=sample.tsv.gz --dry
python3 memc_load_multi.py --pattern=sample.tsv.gz --dry

pytest -v tests/test_memc_load_multi.py
```